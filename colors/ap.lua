...
local comments = "#57606f"
local selected_text = "#00ffff"
local chars_and_strings = "#dba740"
local chars_and_strings_2 = "#ffa502"
local numbers = "#ffcc00"
local brackets = "#f1f2f6"
local cursor_line = "#3d3d3d"
local keywords1 = "#ffcc00"
local keywords2 = "#ffa502"
local line_number = "#57606f"
local text = "#f1f2f6"
local match_search = "#00ffff"
local border = "#3d3d3d"
local title = "#00ffff"
local string_escape = "#ffcc00"
local background = "#2F3542"
